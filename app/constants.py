...
FIELD_KEYWORD_ALIASES = {
    ...
    'màu':          ['màu', 'màu sắc', 'phối màu', 'ngoại hình', 'thiết kế', 'thiết kế màu', 'màu sắc led', 'đèn led', 'rgb'],
    'led':          ['led', 'hệ thống led', 'màu sắc led', 'đèn led', 'rgb'],
    'khe M.2':      ['khe m.2', 'm.2', 'ssd m.2', 'nvme', 'ổ ssd'],
    'lưu trữ':      ['lưu trữ', 'ổ cứng', 'hdd', 'storage', 'cổng lưu trữ', 'sata', 'kết nối ổ cứng', 'giao tiếp ổ cứng', 'ssd m.2'],
    'pcie':         ['pcie', 'khe cắm pcie', 'pci express', 'khe mở rộng', 'băng thông pcie', 'khe cắm card', 'khe cắm đồ họa', 'chuẩn pcie', 'giao tiếp', 'chuẩn giao tiếp', 'giao tiếp khe cắm'],
    'interface':    ['interface', 'giao tiếp', 'chuẩn giao tiếp', 'giao tiếp khe cắm', 'chuẩn cắm', 'khe cắm'],
    'kích thước':   ['kích thước', 'form factor', 'atx', 'micro atx', 'matx', 'mini itx', 'cỡ', 'size'],
    'Ram hỗ trợ':   ['ram hỗ trợ', 'ddr4', 'ddr5', 'loại ram', 'chuẩn ram', 'thế hệ ram', 'chuẩn bộ nhớ', 'hỗ trợ ram gì'],
    'chipset':      ['chipset', 'chip xử lý', 'loại chip', 'dòng card', 'chip đồ họa', 'chipset xử lý'],
}
