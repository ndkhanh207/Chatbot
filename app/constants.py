...
FIELD_KEYWORD_ALIASES = {
    ...
    'màu':          ['màu', 'màu sắc', 'phối màu', 'ngoại hình', 'thiết kế', 'thiết kế màu'],
    'khe M.2':      ['khe m.2', 'm.2', 'ssd m.2', 'nvme', 'ổ ssd'],
    'lưu trữ':     ['lưu trữ', 'ổ cứng', 'hdd', 'storage', 'cổng lưu trữ', 'sata', 'kết nối ổ cứng'],
    'pcie':         ['pcie', 'khe cắm pcie', 'pci express', 'khe mở rộng', 'băng thông pcie', 'khe cắm card'],
    'interface':    ['interface', 'giao tiếp', 'chuẩn giao tiếp', 'giao tiếp khe cắm'],
