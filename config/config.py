...
OLLAMA_REQUEST_TIMEOUT = max(1.0, float(_env('OLLAMA_REQUEST_TIMEOUT', '90')))
MAX_PARALLEL_REQUESTS = max(1, int(_env('MAX_PARALLEL_REQUESTS', _env('OLLAMA_NUM_PARALLEL', '2'))))
MODEL_QUEUE_TIMEOUT_SECONDS = max(0.1, float(_env('MODEL_QUEUE_TIMEOUT_SECONDS', '5')))
MODEL_PROCESSING_TIMEOUT_SECONDS = max(1.0, float(_env('MODEL_PROCESSING_TIMEOUT_SECONDS', '90')))
RAGAS_MAGIC_KEY = _env('RAGAS_MAGIC_KEY', '')
...
class Config:
    ...
    MODEL_QUEUE_TIMEOUT_SECONDS = MODEL_QUEUE_TIMEOUT_SECONDS
    MODEL_PROCESSING_TIMEOUT_SECONDS = MODEL_PROCESSING_TIMEOUT_SECONDS
    RAGAS_MAGIC_KEY = RAGAS_MAGIC_KEY
...
all = [
    ...
    'MODEL_PROCESSING_TIMEOUT_SECONDS',
    'RAGAS_MAGIC_KEY',
    'VECTOR_DB_DIR',
    'MYSQL_CONNECTION_STRING',
    'PC_STORE_DATA',
